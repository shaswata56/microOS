...
I've written this minimal Kernel & OS by following the OSDev tutorial. Currently it supports only kernel mode, no usermode implemented and no plan to do it.
